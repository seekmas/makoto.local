 ...
 */
class PostCategory extends \Makoto\AdminBundle\Entity\PostCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\PostCategory' . "\0" . 'id', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\PostCategory' . "\0" . 'subject', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\PostCategory' . "\0" . 'alias', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\PostCategory' . "\0" . 'orderId', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\PostCategory' . "\0" . 'description', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\PostCategory' . "\0" . 'post');
        }
