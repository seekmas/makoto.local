 ...
 */
class ContactType extends \Makoto\AdminBundle\Entity\ContactType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\ContactType' . "\0" . 'id', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\ContactType' . "\0" . 'subject', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\ContactType' . "\0" . 'icon', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\ContactType' . "\0" . 'orderId', '' . "\0" . 'Makoto\\AdminBundle\\Entity\\ContactType' . "\0" . 'contact');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ContactType $proxy) {
