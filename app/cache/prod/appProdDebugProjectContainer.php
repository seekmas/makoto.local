...
class appProdDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/wwwroot/makoto.local/app/cache/prod/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $c = new \Assetic\Cache\ConfigCache('/home/wwwroot/makoto.local/app/cache/prod/assetic/config');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_7c00e75b6074c221730dec4d827ba4ae7bcda3f743b28e70a7545f71eef0d2ea');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_7c00e75b6074c221730dec4d827ba4ae7bcda3f743b28e70a7545f71eef0d2ea');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_7c00e75b6074c221730dec4d827ba4ae7bcda3f743b28e70a7545f71eef0d2ea');
        ...
        $f->setProxyDir('/home/wwwroot/makoto.local/app/cache/prod/doctrine/orm/Proxies');
    ...
    protected function getJmsSerializerService()
    {
        ...
        $a->setCache(new \Metadata\Cache\FileCache('/home/wwwroot/makoto.local/app/cache/prod/jms_serializer'));
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/wwwroot/makoto.local/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/wwwroot/makoto.local/app/config/routing.yml', array('cache_dir' => '/home/wwwroot/makoto.local/app/cache/prod', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appProdUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appProdUrlMatcher', 'strict_requirements' => NULL), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/wwwroot/makoto.local/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/wwwroot/makoto.local/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('/home/wwwroot/makoto.local/app/cache/prod/sonata/admin', true);
    }
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.post', 1 => 'sonata.admin.post_category', 2 => 'sonata.timeline.blocks', 3 => 'sonata.admin.blocks', 4 => 'sonata.user.admin.user', 5 => 'sonata.user.admin.group', 6 => 'sonata.media.admin.media', 7 => 'sonata.media.admin.gallery', 8 => 'sonata.media.admin.gallery_has_media'), $this);
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/wwwroot/makoto.local/app/cache/prod/translations', 'debug' => true));
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/wwwroot/makoto.local/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/wwwroot/makoto.local/src/Application/Sonata/UserBundle/Resources/views', 'ApplicationSonataUser');
        $instance->addPath('/home/wwwroot/makoto.local/vendor/sonata-project/media-bundle/Resources/views', 'SonataMedia');
        $instance->addPath('/home/wwwroot/makoto.local/src/Application/Sonata/MediaBundle/Resources/views', 'ApplicationSonataMedia');
        $instance->addPath('/home/wwwroot/makoto.local/src/Makoto/ExtensionBundle/Resources/views', 'MakotoExtension');
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/wwwroot/makoto.local/app/../web', true);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/wwwroot/makoto.local/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/wwwroot/makoto.local/app/cache/prod',
            ...
            'debug.container.dump' => '/home/wwwroot/makoto.local/app/cache/prod/appProdDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/wwwroot/makoto.local/app/cache/prod/sessions',
            ...
            'router.resource' => '/home/wwwroot/makoto.local/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/wwwroot/makoto.local/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/wwwroot/makoto.local/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/wwwroot/makoto.local/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/wwwroot/makoto.local/app/cache/prod/doctrine/orm/Proxies',
